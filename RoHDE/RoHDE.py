    ...
    # Purpose: Trains and evaluates models for 
    # high-density sEMG data, including both GANs (
    # for data generation) and classifiers.
    # What it does:
    #     Loads data and sets up both a generator
    # (GAN) and a classifier (e.g., MobileNetV2).
    #     Trains the classifier using synthetic 
    #     data generated by the GAN.
    #     Evaluates classifier performance 
    #     with voting and latency metrics.
    #     Logs results for analysis.
    # Use case: Use this script for advanced 
    # training setups, such as training 
    # classifiers with GAN-generated 
    # data or benchmarking with different voting windows.
